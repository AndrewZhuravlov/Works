const questions = [
    {
        'question' : 'In what childrens game are participants chased by someone designated \'It\'?',
        'content' : [
            'Tag',
            'Simon Says',
            'Charades',
    ...
    {
        'question' : 'In the U.S., if its not Daylight Saving Time, its what?',
        'content' : [
            'Borrowed time',
            'Overtime',
            'Standard time',
    ...
    },
    {
        ...
        'question': 
        `A guarantee to an exporter that the importer of his goods will pay immediately for the goods ordered 
        by him, is known as`
    },
    {
        'correct': 3,
    ...
    },
    {
        ...
        'question': 'When is the Worlds Diabetes Day?'
    },
    {
        'correct': 0,
        'content': [
    ...
    },
    {
        ...
        'content': [
            ...
            'Centripetal force due to the earths rotation',
    ...
    },
    {
        ...
        'question': 'Karl Marxs ideology advocated'
    },
    {
        'correct': 0,
        'content': [
    ...
    {
        'question' : 'Which month has only 28 days (unless its a leap year)?',
        'content' : [
            'March',
            'September',
            'June',
    ...
    },
    {
        ...
        'content': [
            ...
            'safeguarded the personal liberties of the people against arbitrary imprisonment by the kings orders',
            'All of the above'
        ],
    ...
    },
    {
        ...
        'question': 'Lhasa airport at Tibet is the Worlds'
    },
    {
        'correct': 2,
        'content' : [
...
localStorage.setItem('myQ', JSON.stringify(questions));